package org.amos.limiter.aspect;


import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.amos.core.basic.exception.LimiterException;
import org.amos.limiter.annotations.RateLimiter;
import org.amos.limiter.components.AbstractRateLimiter;
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(org.amos.limiter.annotations.RateLimiter)")
    public void cut(){};
