package org.amos.starter.limit.lite.aspect;

import lombok.extern.slf4j.Slf4j;
import org.amos.core.basic.exception.LimiterException;
import org.amos.starter.limit.lite.annotation.RateLimiter;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(org.amos.starter.limit.lite.annotation.RateLimiter)")
    public void cut() {
