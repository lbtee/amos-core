...
public class SqlHelper {
     ...
     * @return 返回查询结果
     */
    public static List<Map<String, Object>> runSql(GenConfig generatorConfig, String sql,
    ...
    public static Connection getConnection(GenConfig generatorConfig) {
    ...
    public static List<Map<String, Object>> runSql(GenConfig dataBaseConfig, String sql) {
    ...
    private static DataSource getDataSource(GenConfig generatorConfig) {
