...
public abstract class TableSelector {
    ...
    private GenConfig generatorConfig;
    private List<String> schTableNames;

    public TableSelector(ColumnSelector columnSelector, GenConfig generatorConfig) {
    ...
    public GenConfig getGeneratorConfig() {
        return generatorConfig;
    }

    public void setGeneratorConfig(GenConfig generatorConfig) {
        this.generatorConfig = generatorConfig;
    }
