...
public class DBConnect {
    ...
    public static Connection getConnection(GenConfig config) throws ClassNotFoundException, SQLException {
     ...
     */
    public static String testConnection(GenConfig generatorConfig) {
        Connection con = null;
        String ret = null;
        try {
